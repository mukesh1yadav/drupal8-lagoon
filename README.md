...
1. image_widget_crop
2. crop
3. install_profile_generator

Steps to create content type for image crop -

- Create crop type in configration -> media -> crop type
- Create a new contant type
- Create a new image field and manage accordingly


Steps to create custom module -

- Go to docor continer usign this commands (sudo docor ps)
- Go to drupal-example image (sudo docker exec -it drupal-example bash)
- Run this command in docor continer to create custom module- (drupal generate:module)


Steps to create field formatter-

- Go to docor continer usign this commands (sudo docor ps)
- Go to drupal-example image (sudo docker exec -it drupal-example bash)
- Run this command in docor continer to create field formatter- (generate:plugin:fieldformatter)
